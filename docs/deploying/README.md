...
OneTV addons require hosting in order to be published. You will need a NodeJS hosting solution, as OneTV Addons made with the OneTV Addon SDK are NodeJS apps.
...
OneTV addons are deployed just like regular nodejs apps, so follow the nodejs instructions provided by your particular service provider.

If you've built a great addon, and need help with hosting your addon, you are welcome to contact the OneTV team
...
If you want your addon to appear in the list of Community addons in OneTV, check out [publishToCentral](../README.md#publishtocentralurl)

If you are not using the Addon SDK to create your addon, you can publish your addon in the list of Community addons in OneTV by contacting the OneTV team
