...
const { serveHTTP, publishToCentral } = require("onetv-addon-sdk")
const addonInterface = require("./addon")
serveHTTP(addonInterface, { port: process.env.PORT || ${Math.floor(Math.random() * 16383) + 49152} })

// when you've deployed your addon, un-comment this line
// publishToCentral("https://my-addon.awesome/manifest.json")
// for more information on deploying, see: https://onetv.media/docs/deploying
`

const headerTmpl = (manifest) => `const { addonBuilder } = require("onetv-addon-sdk")

// Docs: https://onetv.media/docs/api/responses/manifest
const manifest = ${JSON.stringify(manifest, null, '\t')}
const builder = new addonBuilder(manifest)
`

// @TODO: auto update the onetv-addon-sdk version
...
builder.defineCatalogHandler(({type, id, extra}) => {
	...
	// Docs: https://onetv.media/docs/api/requests/defineCatalogHandler
...
builder.defineMetaHandler(({type, id}) => {
	...
	// Docs: https://onetv.media/docs/api/requests/defineMetaHandler
...
builder.defineStreamHandler(({type, id}) => {
	...
	// Docs: https://onetv.media/docs/api/requests/defineStreamHandler
...
builder.defineSubtitlesHandler(({type, id, extra}) => {
	...
	// Docs: https://onetv.media/docs/api/requests/defineSubtitlesHandler
